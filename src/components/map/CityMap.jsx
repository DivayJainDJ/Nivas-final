...
import { ROUTES, complaintDetailPath } from '../../lib/navigation/routes.js'
          ...
          housingUnits.map((unit) => {
            ...
            return (
              <rect
                ...
                onClick={() => navigate(ROUTES.HOUSING_MATCH, { state: { source: 'dashboard-fallback-housing-marker', unitId: unit.id } })}
                onKeyDown={(event) => {
                  if (event.key === 'Enter' || event.key === ' ') navigate(ROUTES.HOUSING_MATCH, { state: { source: 'dashboard-fallback-housing-marker', unitId: unit.id } })
                }}
              />
            )
          })}
            ...
            return (
              <circle
                ...
                onClick={() => {
                  ...
                  navigate(complaintDetailPath(complaint.id), { state: { source: 'dashboard-fallback-complaint-marker' } })
                }}
                onKeyDown={(event) => {
