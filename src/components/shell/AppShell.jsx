...
export default function AppShell() {
  ...
  useEffect(() => {
    logRouteTransition(previousPathRef.current, location.pathname)
    previousPathRef.current = location.pathname
    closeCommandPalette()
    setNotificationDrawerOpen(false)
    clearToasts()
  }, [clearToasts, closeCommandPalette, location.pathname, setNotificationDrawerOpen])
  ...
  }, [chromeHidden, location.pathname, reducedMotion])
