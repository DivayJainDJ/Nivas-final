...
export default function ComplaintsPage() {
  ...
  const selectComplaint = (id) => {
    ...
    navigate(complaintDetailPath(id), { replace: false })
  }

  const closeDetailFlow = () => {
    useComplaintsPageStore.getState().closeDetail()
    if (complaintId) navigate(ROUTES.COMPLAINTS, { replace: true })
  }
  ...
  return (
    <div ref={pageRef} className="mx-auto max-w-[1640px] space-y-6 px-3 pb-28 pt-4 md:px-8">
      ...
      <ComplaintDetailDrawer complaint={selectedComplaint} complaints={complaints} onStatusUpdate={updateStatus} onCloseDetail={closeDetailFlow} />
