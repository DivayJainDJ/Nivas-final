import { ROUTES, browserNavigate, complaintDetailPath, slumPlannerPath } from '@/lib/navigation/routes.js'
  ...
  showComplaintNotification(
    ...
    this.showNotification(titles[type], {
      ...
      onClick: () => {
        ...
        browserNavigate(complaintDetailPath(complaint.id))
      },
    })
  }
  ...
  showHousingNotification(
    ...
    this.showNotification(titles[type], {
      ...
      onClick: () => {
        ...
        browserNavigate(ROUTES.HOUSING_MATCH)
      },
    })
  }
  ...
  showWardNotification(
    ...
    this.showNotification(titles[type], {
      ...
      onClick: () => {
        ...
        browserNavigate(slumPlannerPath(data.wardId))
      },
    })
  }
