...
import { Bot, Clock, Image, MapPin, MessageSquare, Send, ShieldCheck, X } from 'lucide-react'
...
export default function ComplaintDetailDrawer({ complaint, complaints, onStatusUpdate, onCloseDetail, onOpenOfficerQueue, detailOpen: detailOpenProp }) {
        ...
        <div className="min-h-0 flex-1 space-y-4 overflow-y-auto p-5">
          ...
          <Section icon={Send} title="Officer actions">
            <div className="grid gap-3">
              ...
              {onOpenOfficerQueue && (
                <button type="button" onClick={() => onOpenOfficerQueue(complaint)} className="inline-flex items-center justify-center gap-2 rounded-2xl border border-product-line bg-white px-4 py-3 text-sm font-bold text-product-navy shadow-soft transition hover:-translate-y-0.5 hover:border-product-indigo">
