...
export default function CommandPalette() {
  const {
    ...
    goToSettings,
    goToSlumPlanner,
  } = useAppNavigation('command-palette')
    ...
    const items = [
      ...
      },
      {
        ...
        onSelect: () => {
          ...
          goToComplaints({ state: { openReport: true } })
        },
      },
      {
  ...
  }, [goToComplaints, goToOfficer, goToSettings, highContrast, markAllNotificationsRead, motionPref, setHighContrast, setMotion, setTheme])
  ...
  }, [commandGroups, complaintResults, goTo, goToComplaintDetail, goToHousingMatch, goToSlumPlanner, housingResults, navResults, q, queryMode, setWardId, wardResults])
